...
registerObjectInfo('HydraHead', { description: 'Attacks anything adjacent to it. Stationary.', flavorText: 'A fleshy tube with a gaping jaw at the end, grasping at any food nearby.' });
